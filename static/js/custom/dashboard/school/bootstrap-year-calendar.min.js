...
! function(a) {
    ...
    b.prototype = {
        ...
        _renderHeader: function() {
            ...
            e.addClass("fa fa-angle-left"), d.append(e), c.append(d);
            ...
            l.addClass("fa fa-angle-right"), k.append(l), c.append(k), b.append(c), this.element.append(b)
        },
        ...
        _applyEvents: function() {
            ...
            c.click(function(c) {
                ...
                var c = a(b.element).width(),
                    ...
                    e = "month-container";
                e += 6 * d < c ? " col-lg-2" : 4 * d < c ? " col-lg-3" : 3 * d < c ? " col-lg-4" : 2 * d < c ? " col-lg-6" : " col-lg-12", a(b.element).find(".month-container").attr("class", e)
            }, 300)
        },
        ...
        _openContextMenu: function(b) {
            ...
            for (var d = this._getDate(b), e = this.getEvents(d), f = 0; f < e.length; f++) {
                ...
                h.addClass("content"), h.text(e[f].name), g.append(h);
